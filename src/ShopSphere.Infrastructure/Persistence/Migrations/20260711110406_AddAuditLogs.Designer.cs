...
namespace ShopSphere.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260711110406_AddAuditLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.Wishlist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.WishlistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.Cart", b =>
                {
                    b.HasOne("ShopSphere.Domain.Entities.Coupon", "Coupon")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopSphere.Domain.Entities.WishlistItem", b =>
                {
                    ...
                    b.HasOne("ShopSphere.Domain.Entities.Wishlist", "Wishlist")
                        .WithMany("Items")
